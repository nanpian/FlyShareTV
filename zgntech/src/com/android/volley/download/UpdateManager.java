...
public class UpdateManager {
	...
	public UpdateManager(Activity mContext, String url) {
		super();
		this.mContext = mContext;
		this.mUpdateUrl = url;
		try {
			this.mSaveName = url.substring(url.lastIndexOf("/") + 1);
		} catch (Exception e) {
	...
	public void downloadApk() {
		if (mUpdateUrl != null && mUpdateUrl.equals("") == false
				&& mSaveName != null && mSaveName.equals("") == false) {
			...
			if (Environment.getExternalStorageState().equals(
				...
				mDownloder.add(filePath, mUpdateUrl, new Listener<Void>() {
					...
					public void onProgressChange(long fileSize,
						...
						DebugLog.d("onProgressChange" + fileSize + "-"
								+ downloadedSize + ";"
