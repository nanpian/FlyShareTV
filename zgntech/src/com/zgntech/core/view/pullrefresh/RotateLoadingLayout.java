...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    public void setLastUpdatedLabel(CharSequence label) {
        // 如果最后更新的时间的文本是空的话，隐藏前面的标题,zhudewei修改，直接隐藏
        mHeaderTimeViewTitle.setVisibility(TextUtils.isEmpty(label) ? View.GONE : View.VISIBLE);
    ...
    public void onPull(float scale) {
       ...
       // animate(mArrowImageView).rotation(angle);
    }
    ...
    private void resetRotation() {
       ...
       // animate(mArrowImageView).rotation(0);
    }
}
