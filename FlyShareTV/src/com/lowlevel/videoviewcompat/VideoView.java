...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    /*
     * @TargetApi(Build.VERSION_CODES.LOLLIPOP) public VideoView(Context
     * context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     * super(context, attrs, defStyleAttr, defStyleRes); initVideoView(); }
     */
    ...
    private void openVideo() {
        ...
        try {
            ...
            try {
                Method m = MediaPlayer.class.getMethod("setDataSource",
