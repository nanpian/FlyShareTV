...
public class MoviesNowAdapter extends BaseAdapter {
    ...
    public MoviesNowAdapter(Context context, List<Movies> moviessList) {
    ...
    public View getView(final int position, View convertView,
        ...
        if (convertView == null) {
            ...
            holder.movieName = (TextView) convertView.findViewById(R.id.name);
            holder.movieShuiYin = convertView.findViewById(R.id.video_shuiyin);
        ...
        if (movie.isMovieTime()) {
            holder.movieImage.setImageResource(movie.getMovieTimeResId());
            holder.movieShuiYin.setVisibility(View.GONE);
        } else {
            Log.d(TAG, "This movie name is " + movie.getName()
                    + " movie url is " + movie.getThumb());
            holder.movieName.setText(movie.getName());
            holder.movieShuiYin.setVisibility(View.VISIBLE);
            ...
            if (false == StringUtils.isNullOrEmpty(movie.getThumb())) {
                ...
                ImageListener imageListener = ImageLoader
                        .getDesiredWidthImageListener(holder.movieImage,
                                R.drawable.video_image_03,
                                R.drawable.video_image_03, width / 2 - 20);
                VolleyRequestManager.getInstance().getImageLoader()
                        .get(movie.getThumb(), imageListener);
            }
        }
    ...
    class ViewHolder {
        ...
        private TextView movieTypeCN;
        private TextView movieTypeEN;
        private View movieShuiYin;
    }
