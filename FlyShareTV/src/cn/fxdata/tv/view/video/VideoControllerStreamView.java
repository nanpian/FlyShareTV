...
class VideoControllerStreamView extends FrameLayout {
    ...
    public VideoControllerStreamView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = null;
        mContext = context;
    ...
    public VideoControllerStreamView(Context context, boolean useFastForward) {
        super(context);
        mContext = context;
    ...
    public VideoControllerStreamView(Context context) {
        this(context, true);
    ...
    protected View makeControllerView() {
        ...
        mRoot = inflate.inflate(R.layout.media_controller_stream, null);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(VideoControllerStreamView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(VideoControllerStreamView.class.getName());
    }
    ...
    private static class MessageHandler extends Handler {
        private final WeakReference<VideoControllerStreamView> mView;

        MessageHandler(VideoControllerStreamView view) {
            mView = new WeakReference<VideoControllerStreamView>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            VideoControllerStreamView view = mView.get();
