...
package cn.fxdata.tv.utils.share.theme.classic;
...
import cn.fxdata.tv.utils.share.FollowerListFakeActivity;
...
public class FollowListPage extends FollowerListFakeActivity implements
    ...
    public void onCreate() {
        ...
        llTitle.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT));
        llPage.addView(llTitle);

        FrameLayout flPage = new FrameLayout(getContext());
        LayoutParams lpFl = new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT);
        lpFl.weight = 1;
    ...
    private static class PRTHeader extends LinearLayout {
        ...
        public PRTHeader(Context context) {
            ...
            LayoutParams lpInner = new LayoutParams(LayoutParams.WRAP_CONTENT,
                    LayoutParams.WRAP_CONTENT);
