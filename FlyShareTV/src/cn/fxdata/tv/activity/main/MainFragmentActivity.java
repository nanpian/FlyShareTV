package cn.fxdata.tv.activity.main;
...
import cn.fxdata.tv.fragment.home.FollowMeFragment;
import cn.fxdata.tv.fragment.home.HotPlayFragment;
import cn.fxdata.tv.fragment.home.LatestVedioFragment;
...
public class MainFragmentActivity extends BaseActivity implements
     ...
     */
    /*
     * private void initFragment() { fragmentManager = new
     * UIFragmentManager(this, R.id.fl_content, getSupportFragmentManager());
