...
import cn.fxdata.tv.adapter.MoviesNowAdapter.OnMoviesListClickListener;
...
public class MoviesPrevAdapter extends BaseAdapter {
    ...
    public MoviesPrevAdapter(Context context, List<Movies> moviessList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                width / 3 - 15, LayoutParams.FILL_PARENT);
        holder.movieImage.setLayoutParams(params);
        holder.movieImage
                .setPadding(DPIUtil.dip2px(5), 0, DPIUtil.dip2px(5), 0);
