...
public class SharedPreferencePersonUtil {
    ...
    public SharedPreferencePersonUtil(Context context) {
        sp = context.getSharedPreferences(PREFERENCES_NAME,
    ...
    /*  *//** 设置wifi 下缓存视频 */
    /*
     * public void setPersonCacheSwitch(String cacheswitch){ editor
     * sp.getString(PERSON_CACHE_SWITCH, cacheswitch); editor.commit(); }
     * 
     * public void getPersonCacheSwitch(){ return
     * sp.getString(PERSON_CACHE_SWITCH, ""); }
     */
