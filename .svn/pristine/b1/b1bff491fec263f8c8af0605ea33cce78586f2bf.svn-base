...
public class FollowMeAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView,
        ...
        ImageLoader.getInstance().displayImage(entity.getThumb(),
                holder.ivBackground);
    ...
    public void setOnFollowMeItemClickListener(
            OnFollowMeItemClickListener listener) {
