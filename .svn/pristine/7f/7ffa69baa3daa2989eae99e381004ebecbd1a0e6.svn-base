...
public class FullScreenVideoStreamView extends SurfaceView implements
        VideoControllerStreamView.MediaPlayerControl {
    ...
    private VideoControllerStreamView mMediaController;
    ...
    public FullScreenVideoStreamView(Context context) {
        super(context);
        this.mContext = context;
        initVideoView();
    }

    public FullScreenVideoStreamView(Context context, AttributeSet attrs) {
    ...
    public void setMediaController(VideoControllerStreamView controller) {
